...
df = pd.read_csv('/data8/han_lab/mhan/abcd/data/Gasperini/Gasperini2019.at_scale.ABC.TF.cobinding.erole.txt', sep="\t", index_col=0)
#del df[df.columns[0]]
#del df[df.columns[0]]
...
for chromosome in df_by_chr.keys():
  ...
  newdf.to_csv("/data8/han_lab/mhan/abcd/data/Gasperini/Gasperini2019.at_scale.ABC.TF.cobinding.erole.grouped.txt", sep="\t")
