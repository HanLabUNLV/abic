...
# ABC
Fulco_enhancer = pd.read_csv("data/Fulco/Fulco2019.enhancer.ABC.overlap.bed", sep='\t')
Fulco_TSS = pd.read_csv("data/Fulco/Fulco2019.TSS.ABC.overlap.bed", sep='\t')
Fulco_crispr = pd.read_csv("data/Fulco/Fulco2019.STable6a.tab", sep="\t")
ABC = pd.read_csv("data/Fulco/ABC.EnhancerPredictionsAllPutative.txt", sep='\t')
...
ABC_enhancer = pd.read_csv("data/Fulco/EnhancerList.txt", sep="\t")
...
ABC_enhancer_H3K4me3 = pd.read_csv("data/Fulco/EnhancerList.H3K4me3.txt", sep="\t")
...
ABC_enhancer_H3K27me3 = pd.read_csv("data/Fulco/EnhancerList.H3K27me3.txt", sep="\t")
...
ABC_gene = pd.read_csv("data/Fulco/GeneList.txt", sep="\t")
ABC_gene = ABC_gene.loc[:,['name','H3K27ac.RPKM.quantile.TSS1Kb']]
ABC_gene_H3K4me3 = pd.read_csv("data/Fulco/GeneList.H3K4me3.txt", sep="\t")
...
ABC_gene_H3K27me3 = pd.read_csv("data/Fulco/GeneList.H3K27me3.txt", sep="\t")
...
TSS_TF = pd.read_csv("data/Fulco/Fulco2019.TSS.TF.overlap.bed", sep="\t", names=['chr', 'start', 'end', 'gene', 'dummy', 'strand', 'chr.TF', 'start.TF', 'end.TF', 'TF', 'score', 'celltype', 'score2'], header=None)  
TSS_TF['count'] = 1
...
enhancer_TF_pivot.to_csv("data/Fulco/Fulco2019.enhancer.TF.txt", sep='\t')
TSS_TF_pivot.to_csv("data/Fulco/Fulco2019.TSS.TF.txt", sep='\t')
...
Fulco_crispr_ABC.drop(Fulco_crispr_ABC.filter(regex='_y$').columns, axis=1, inplace=True)
Fulco_crispr_ABC.to_csv("data/Fulco/Fulco2019.CRISPR.ABC.TF.txt", sep='\t')
...
cobinding = pd.DataFrame(np.logical_and(e_TF, TSS_TF)).astype(int)  
...
Fulco_crispr_ABC.to_csv("data/Fulco/Fulco2019.CRISPR.ABC.TF.cobinding.allsig.txt", sep='\t')
...
Fulco_crispr_ABC.to_csv("data/Fulco/Fulco2019.CRISPR.ABC.TF.cobinding.txt", sep='\t')

# erole
#erole = pd.read_csv("data/Fulco/Fulco2019.CRISPR.eroles.txt", sep="\t")
...
#Fulco_crispr_ABC.to_csv("data/Fulco/Fulco2019.CRISPR.ABC.TF.cobinding.erole.txt", sep='\t')
