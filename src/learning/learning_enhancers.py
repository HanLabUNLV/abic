  ...
  def __call__(self, trial):
    ...
    if self.classifier == "xgb":
      param = { 
          ...
          "tree_method": "auto",
          # n_estimator
          "num_boost_round": trial.suggest_int("num_boost_round", 200, 400),
          # defines booster
          ...
          "gamma": trial.suggest_float("gamma", 20, 30),
...
class OuterFolds:
    ...
    def drop_features(self):
        ...
        #features_to_keep = np.append(features_to_keep, ['ABC.Score', 'ABC.Score.Numerator'])
        features_to_keep = np.append(features_to_keep, ['enhancerID'])
...
#############
      ...
      ActivityFeatures = features_gasperini[['enhancerID', 'normalized_dhs',  'normalized_h3K27ac',  'normalized_h3K4me3',  'normalized_h3K27me3']].copy()
      ...
      hicfeatures = features_gasperini[['joined.ABC.sum', 'joined.ABC.max',  'TSS.count.near.enhancer', 'mean.contact.from.enhancer',  'max.contact.from.enhancer', 'total.contact.from.enhancer' ]].copy()
