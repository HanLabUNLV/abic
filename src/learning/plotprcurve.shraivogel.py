...
if __name__ == "__main__":
    ...
    pr_test = [
            "applymodel/Shraivogel/pr_curve.boruta7.2pass.save.0.txt",
            "applymodel/Shraivogel/pr_curve.boruta7.2pass.save.1.txt",
            "applymodel/Shraivogel/pr_curve.boruta7.2pass.save.2.txt",
            "applymodel/Shraivogel/pr_curve.boruta7.2pass.save.3.txt", 
            ]
    confusion_test = [
        "applymodel/Shraivogel/confusion.boruta7.2pass.save.0.txt",
        "applymodel/Shraivogel/confusion.boruta7.2pass.save.1.txt",
        "applymodel/Shraivogel/confusion.boruta7.2pass.save.2.txt",
        "applymodel/Shraivogel/confusion.boruta7.2pass.save.3.txt",
        ]
    ...
    plt.plot(recall, precision, color='red',
             label=r'Test(Shraivogel) (AUC = %0.2f)' % (average_precision_score(y_real_test, y_proba_test)),
             lw=2, alpha=.8)



    ABC_pd = pd.read_csv('data/Shraivogel/CRISPR.ABC.TF.cobinding.txt', sep="\t", index_col=None)
