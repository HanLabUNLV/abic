...
#####################
  ...
  # same feature engineering as training
  ActivityFeatures = X_test[['enhancerID', 'normalized_dhs',  'normalized_h3K27ac',  'normalized_h3K4me3',  'normalized_h3K27me3']].copy()
  ActivityFeatures = ActivityFeatures.dropna()
  hicfeatures = X_test[['joined.ABC.sum', 'joined.ABC.max',  'TSS.count.near.enhancer', 'mean.contact.from.enhancer',  'max.contact.from.enhancer', 'total.contact.from.enhancer' ]].copy()
