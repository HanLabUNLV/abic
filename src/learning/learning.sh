python src/learning/learning.py --dir data/Gasperini/ --outdir run.all --port 17203 --studyname all --init --infile Gasperini2019.at_scale.ABC.TF.NMF.erole.grouped.train.txt
...
python -i src/learning/runshap.py --modeldir run.all/ --studyname all.2pass --outdir apply.all/
