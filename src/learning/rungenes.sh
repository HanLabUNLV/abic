...
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --opt --model 'xgb' --outerfold 0 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --opt --model 'xgb' --outerfold 0 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --opt --model 'xgb' --outerfold 0 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --opt --model 'xgb' --outerfold 1 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --opt --model 'xgb' --outerfold 1 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --opt --model 'xgb' --outerfold 1 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --opt --model 'xgb' --outerfold 2 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --opt --model 'xgb' --outerfold 2 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --opt --model 'xgb' --outerfold 2 & 

  
python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --test

python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --fs --model 'xgb' --outerfold 0 &> fs.0.log &
python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --fs --model 'xgb' --outerfold 1 &> fs.1.log &
python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --fs --model 'xgb' --outerfold 2 &> fs.2.log &

python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --dropfeatures 


python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes --init2pass 

nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes.2pass --opt --model 'xgb' --outerfold 0 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes.2pass --opt --model 'xgb' --outerfold 0 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes.2pass --opt --model 'xgb' --outerfold 0 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes.2pass --opt --model 'xgb' --outerfold 1 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes.2pass --opt --model 'xgb' --outerfold 1 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes.2pass --opt --model 'xgb' --outerfold 1 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes.2pass --opt --model 'xgb' --outerfold 2 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes.2pass --opt --model 'xgb' --outerfold 2 & 
nohup python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes.2pass --opt --model 'xgb' --outerfold 2 & 
   


python src/learning/learning_genes.py  --outdir run_genes --port 17203 --studyname genes.2pass --test
