...
if __name__ == "__main__":
    ...
    pr_cv = [
            "run.boruta/run.boruta6/boruta6.2pass.pr_curve.xgb.0.txt",
            "run.boruta/run.boruta6/boruta6.2pass.pr_curve.xgb.1.txt",
            "run.boruta/run.boruta6/boruta6.2pass.pr_curve.xgb.2.txt",
            "run.boruta/run.boruta6/boruta6.2pass.pr_curve.xgb.3.txt", 
            ]
    confusion_cv = [
        "run.boruta/run.boruta6/boruta6.2pass.confusion.xgb.0.txt",
        "run.boruta/run.boruta6/boruta6.2pass.confusion.xgb.1.txt",
        "run.boruta/run.boruta6/boruta6.2pass.confusion.xgb.2.txt",
        "run.boruta/run.boruta6/boruta6.2pass.confusion.xgb.3.txt",
        ]
    pr_test = [
            "run.applymodel/boruta6/pr_curve.boruta6.2pass.save.0.txt",
            "run.applymodel/boruta6/pr_curve.boruta6.2pass.save.1.txt",
            "run.applymodel/boruta6/pr_curve.boruta6.2pass.save.2.txt",
            "run.applymodel/boruta6/pr_curve.boruta6.2pass.save.3.txt", 
            ]
    confusion_test = [
        "run.applymodel/boruta6/confusion.boruta6.2pass.save.0.txt",
        "run.applymodel/boruta6/confusion.boruta6.2pass.save.1.txt",
        "run.applymodel/boruta6/confusion.boruta6.2pass.save.2.txt",
        "run.applymodel/boruta6/confusion.boruta6.2pass.save.3.txt",
        ]
    ...
    ABC_pd = pd.read_csv('/data8/han_lab/mhan/abcd/data/Gasperini/Gasperini2019.at_scale.ABC.txt', sep="\t", index_col=None)
